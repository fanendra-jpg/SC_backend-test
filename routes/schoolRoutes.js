...
router.get('/college',auth, schoolController.getCollege);
router.get('/Schooluser', schoolController.getSchoolsuser);
router.get('/collegeuser', schoolController.getCollegeuser);
router.get('/Userinstitute', schoolController.Userinstitute);
router.get('/institute',auth, schoolController.institute);
